...
final class GenerateAuthUri extends Command
{
    ...
    protected function configure(): void
    {
        ...
        $this->addOption('redirect-uri', 'u', InputOption::VALUE_REQUIRED, 'Set RedirectUri. If not input, using env.', null);
        $this->addOption('state', 's', InputOption::VALUE_REQUIRED, 'Set State. If not input, generate automatically.', null);
        $this->addOption('response-mode', 'm', InputOption::VALUE_REQUIRED, 'Set ResponseMode. Allowed "form_post" only.', null);
    }
